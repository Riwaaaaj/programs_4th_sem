  ...
  void interface() {
    ...
    while (choice != 5) {
        ...
        case 1:
            ...
            cin >> item;
            cout << "Insert at: 1. Beginning 2. Between (Position must be valid i.e not 1st or last) 3. End: ";
            cin >> insertChoice;
        ...
        case 2:
            cout << "Delete from: 1. Beginning 2. Between (Position must be valid i.e not 1st or last) 3. End: ";
            cin >> deleteChoice;
...
int main() {
    ...
    // cout << "After concatenating obj 1 and 2, we got the following result in obj1.\n";
    // obj1.traverse();
    return 0;
}
/*
...
Insert at: 1. Beginning 2. Between (Position must be valid i.e not 1st or last) 3. End: 3
Menu( 1. Insert 2. Delete 3. Traverse 4. Search 5. Exit) : 2
Delete from: 1. Beginning 2. Between (Position must be valid i.e not 1st or last) 3. End: 3
Menu( 1. Insert 2. Delete 3. Traverse 4. Search 5. Exit) : 1
Enter item to insert: 3
Insert at: 1. Beginning 2. Between (Position must be valid i.e not 1st or last) 3. End: 1
...
Insert at: 1. Beginning 2. Between (Position must be valid i.e not 1st or last) 3. End: 2
